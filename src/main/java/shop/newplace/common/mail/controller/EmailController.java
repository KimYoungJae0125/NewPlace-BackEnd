...
public class EmailController {
	...
	public void addEmailValidator(WebDataBinder webDataBinder) {
		if(webDataBinder.getTarget() instanceof EmailDto.RequestEmailAuthentication) {
			webDataBinder.addValidators(emailAuthenticationValidator);
		}
		if(webDataBinder.getTarget() instanceof EmailDto.RequestTemporyPassword) {
	...
	public ResponseEntity emailAuthentication(@Valid @RequestBody EmailDto.RequestEmailAuthentication emailDto) {
		EmailDto.ResponseInfo emailInfo = emailService.emailAuthentication(emailDto);
	...
	public ResponseEntity sendEmailAuthentication(@Valid @RequestBody EmailDto.RequestEmailAuthentication emailDto) {
	...
	public ResponseEntity temporaryPassword(@Valid @RequestBody EmailDto.RequestTemporyPassword usersTemporyPassword) {
